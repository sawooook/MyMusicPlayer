...
public  class MainActivity extends BaseActivity {
    ...
    private void initWigets() {
        ...
        if (mPath==null){
            Toast.makeText(getApplicationContext(),"음악이 존재하지 않습니다！",Toast.LENGTH_SHORT).show();
            finish();
        }
        ...
        currentMusicText.setText(mp3Info.getDisplayName());
...
//                currentMusicText.setText(last.getDisplayName()+"——"+last.getArtist());
                currentMusicText.setText(last.getDisplayName());
...
//                currentMusicText.setText(next.getDisplayName()+"——"+next.getArtist());
                currentMusicText.setText(next.getDisplayName());
