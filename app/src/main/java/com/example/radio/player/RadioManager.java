...
public class RadioManager {
    ...
    public static com.example.radio.player.RadioService getService(){
        return service;
    }

    public void playOrPause(String streamUrl,String player){

        service.playOrPause(streamUrl,player);
    }
